<template>
  <div class="log-w3 h-screen">
    <div class="w3layouts-main">
      <h2>Đăng nhập ngay</h2>
      <form action="#" method="post" @submit="handleLogin($event)">
        <input
          type="email"
          class="ggg"
          name="Email"
          placeholder="Tài khoản"
          v-model="dataLogin.account"
        />
        <input
          type="password"
          class="ggg"
      ...
      <p>
        Bạn chưa có tài khoản ?<a href="registration.html">Tạo tài khoản</a>
      </p>
    </div>
  </div>
</template>
...
<script lang="ts" setup>
  ...
  let dataLogin = reactive<LoginProps>({
    account: null,
    password: null,
  })
